...
{
    public partial class FrmOfficerParadestate : Form
    {
        Officer oofficer;
        public FrmOfficerParadestate(Officer officer)
        {
            oofficer = officer;
            InitializeComponent();
        }
        ...
        private void FrmOfficerParadestate_Load(object sender, EventArgs e)
        {
