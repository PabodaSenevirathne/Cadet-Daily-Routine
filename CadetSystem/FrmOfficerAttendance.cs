...
{
    public partial class FrmOfficerAttendance : Form
    {
        Officer oofficer;
        public FrmOfficerAttendance(Officer officer)
        {
            oofficer = officer;
            InitializeComponent();
        }
        ...
        private void FrmOfficerAttendance_Load(object sender, EventArgs e)
        {
        ...
        private void btnview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string query = "SELECT Totalcount,Presentcount,Absentcount,Submittedby,SubmittedOn from KDUattendance  where Intake = @Intake and Attendancedate = @Attendancedate";

                    SqlCommand sqlcmd = new SqlCommand();
                    DataAccessLayer.AddParameters(sqlcmd, "@Attendancedate", SqlDbType.DateTime, dtpdate.Value.ToString("yyyy-MM-dd"));
            ...
            try
            {
                    ...
                    string query = "select d.Absentname from KDUattendancedetails d, KDUattendance a where a.Id=d.AttendanceId and a.Intake = @Intake and a.Attendancedate = @Attendancedate";
